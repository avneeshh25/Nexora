...
const chatting = () => {
    ...
    <div>
              <section className="relative h-screen bg-black">
                {/* <video
                  ...
                  src="https://www.canva.com/design/DAGlzaSuPuE/FGtdryGukXup8HUgXC0LxA/watch" // Replace with your video URL
                   autoPlay
                   loop
                   muted
                  playsInline
  ...
  src="https://www.canva.com/design/DAGlzaSuPuE/FGtdryGukXup8HUgXC0LxA/watch" 
  title=" video player"
  allow="fullscreen"
  allowFullScreen
></iframe> */}
<img className="absolute inset-0 w-full h-full object-cover opacity-50" src="https://cms-artifacts.artlist.io/content/generated-image/image__7/generated-image-98acdef5-72fb-4db2-8ed7-21b5c9fec2e9.jpg?Expires=2061094669&Key-Pair-Id=K2ZDLYDZI2R1DF&Signature=N~Z1Er8ySIEngpCvnXfB-9dAWNLRNtLSxC1hNVFj4KrV3svCk89V1q1sqOVbODeWZ9fCnLhDfKi-0JM1b9wLKrI~5Z6sIQCQEabuXIkwxBzP4fd9C~~N1-WpVYZstlNkEqjtKie5bdfA5f8OJ7ImtaBWIVf-MPucZB5~0vMH3vW21d~OpFFWZHTIdMW6JDvImlj19dtbKJ3CbGsCmbhtAY80AQ2YMQvZP0bIqwwFE5GUV4lMrT94N4nVEJIbRQVP-wynKJqt43uMhsHTy3vwYIPkOWyvZmpqGoTzMkjs4rHXhHo58xIyZe5zw9gRiVY0YKerwAtY9RTPZpaqSe3DKw__"/>
{/* <iframe 
  
  className="absolute inset-0 w-full h-full border-none" 
  src="https://www.canva.com/design/DAGlzaSuPuE/FGtdryGukXup8HUgXC0LxA/watch?embed" 
  title="Canva Video" 
  allow="autoplay; encrypted-media; fullscreen"
  allowFullScreen
></iframe> */}

<a href="https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAGlzaSuPuE&#x2F;FGtdryGukXup8HUgXC0LxA&#x2F;watch?utm_content=DAGlzaSuPuE&amp;utm_campaign=designshare&amp;utm_medium=embeds&amp;utm_source=link" target="_blank" rel="noopener">Green Modern Phone Social Media Chat Video</a> by Lakshya Shukla
                <div className="relative z-10 bg-gradient-to-b from-violet-600/10 via-transparent to-black/50 h-full flex items-center">
                  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 space-y-8">
                    {/* Title */}
          ...
          <div className="relative p-6 md:p-16">
            ...
            <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
              <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
                <h2 className="text-6xl text-gray-800 font-bold sm:text-4xl dark:text-neutral-200 ">
                ...
                <nav className="grid gap-4 mt-5 md:mt-10" aria-label="Tabs" role="tablist" aria-orientation="vertical">
                  ...
                  <button type="button" className="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-200 focus:outline-hidden focus:bg-gray-200 p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" id="tabs-with-card-item-3" aria-selected="false" data-hs-tab="#tabs-with-card-3" aria-controls="tabs-with-card-3" role="tab">
                   ...
                   <span className="grow">
                        ...
                        <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">Agora’s Chat APIs provide the flexibility to integrate powerful and interactive 3rd party solutions so you can fully customize the chat experience for your users.</span>
                      </span>
                    </span>
                  </button>
                </nav>
                ...
                <div className="relative">
                  ...
                  <div>
                    <div id="tabs-with-card-1" role="tabpanel" aria-labelledby="tabs-with-card-item-1">
                      <img className="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/20" src="https://plus.unsplash.com/premium_photo-1722169898948-5c7fa92f4042?q=80&w=2011&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Features Image" />
                    </div>
        
                    <div id="tabs-with-card-2" className="hidden" role="tabpanel" aria-labelledby="tabs-with-card-item-2">
                      <img className="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/20" src="https://images.unsplash.com/photo-1640021677186-54388b9e228c?q=80&w=2000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Features Image" />
                    </div>
        
                    <div id="tabs-with-card-3" className="hidden" role="tabpanel" aria-labelledby="tabs-with-card-item-3">
                      <img className="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/20" src="https://plus.unsplash.com/premium_photo-1677093905889-c60a2db5d5c8?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Features Image" />
                    </div>
                  </div>
                  {/* End Tab Content */}
        ...
        <div class=" py-6 sm:py-8 lg:py-12">
          <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div class="mb-6 flex items-end justify-between gap-4">
              <h2 class="text-2xl font-bold text-white lg:text-6xl">Add chat to any real-time communication use case</h2>
            ...
            <div class="grid gap-x-3 gap-y-6 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-2 xl:grid-cols-3">
              <div>
                ...
                <div class="flex flex-col">
                  <span class="text-white text-3xl">EDUCATION</span>
                  <a href="#" class="text-lg font-bold text-white transition duration-100 hover:text-gray-500 lg:text-xl">Make learning more accessible to students everywhere with virtual classrooms, leveraging real-time communication to enhance interaction and engagement in the educational process.</a>
                </div>
              </div>
              <div>
                <a href="#" class="group mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
              ...
              <div>
                ...
                <div class="flex flex-col">
                  <span class="text-white text-3xl">GAMING</span>
                  <a href="#" class="text-lg font-bold text-white transition duration-100 hover:text-gray-500 lg:text-xl">Increase in-game session time, stickiness, and gamer retention with live video chatting, extending compatibility across multiple platforms to ensure a seamless gaming experience for all users.</a>
                </div>
              </div>
              <div>
                <a href="#" class="group mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
                  <img src="https://images.unsplash.com/photo-1542744095-291d1f67b221?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" loading="lazy" alt="Photo by Austin Wade" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                </a>
                <div class="flex flex-col">
                  <span class="text-white text-3xl">RETAIL</span>
                  <a href="#" class="text-lg font-bold text-white transition duration-100 hover:text-gray-500 lg:text-xl">Create new revenue streams through live interactive shopping experiences with our video APIs.</a>
                </div>
              </div>
              <div>
                <a href="#" class="group mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
                ...
                <div class="flex flex-col">
                  <span class="text-white text-3xl">SOCIAL</span>
                  <a href="#" class="text-lg font-bold text-white transition duration-100 hover:text-gray-500 lg:text-xl">Drive deeper connections with friends and family across the world, enriching each moment with customized video experiences tailored to your personal interactions and preferences.</a>
                </div>
              </div>
              <div>
                <a href="#" class="group mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
                ...
                <div class="flex flex-col">
                  <span class="text-white text-3xl">TELEHEALTH</span>
        ...
        {/* End Video Section */}
              ...
              {/* Footer Section */}
              <footer className="bg-gray-900 text-gray-400 py-8 px-6 sm:px-8 lg:px-12">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                  {/* About Column */}
                  <div>
                    <h3 className="text-white text-lg font-bold mb-4">About Nexora</h3>
                    <p className="text-sm">
                      Nexora is your go-to platform for creating immersive and scalable real-time experiences. Simplify your communication with cutting-edge features.
                    </p>
                  </div>
                  {/* Quick Links Column */}
                  <div>
