...
const SignUpPage = () => {
  ...
  return (
    <div className="flex h-screen bg-black items-center justify-center bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#a600ff] p-4 sm:p-0">
      <div className="bg-gradient-to-br from-[#1a1a2e] to-[#302b63] p-6 sm:p-10 rounded-xl shadow-xl w-full max-w-md text-white">
        <h2 className="text-2xl sm:text-3xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-pink-500 to-blue-500">
          Create an Account
        </h2>
