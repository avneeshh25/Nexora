...
const App = () => {
  ...
  return (
    <div className="font-sans text-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-900 to-indigo-700 bg-clip-text text-transparent">RealTime Connect</h1>
            </div>
            <nav className="hidden md:flex space-x-8">
              <a href="#features" className="text-gray-600 hover:text-blue-800 font-medium">Features</a>
              <a href="#solutions" className="text-gray-600 hover:text-blue-800 font-medium">Solutions</a>
              <a href="#pricing" className="text-gray-600 hover:text-blue-800 font-medium">Pricing</a>
              <a href="#docs" className="text-gray-600 hover:text-blue-800 font-medium">Documentation</a>
            </nav>
            <div className="flex items-center space-x-4">
              <button className="hidden md:inline-block px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-800">Sign In</button>
              <button className="px-4 py-2 rounded-md bg-gradient-to-r from-blue-800 to-indigo-600 text-white font-medium hover:opacity-90 transition-opacity">Get Started</button>
            </div>
          </div>
        </div>
      </header>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-r from-blue-900 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 text-white mb-10 md:mb-0">
              <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-6">Build Real-Time Interactive Experiences</h2>
            ...
            <div className="md:w-1/2">
              <div className="bg-white p-6 rounded-xl shadow-xl">
                <div className="bg-gradient-to-r from-blue-100 to-indigo-100 rounded-lg p-6 h-64 flex items-center justify-center">
                  <img src="/api/placeholder/400/320" alt="Platform demonstration" className="rounded-lg shadow-md" />
                </div>
              </div>
            </div>
          </div>
